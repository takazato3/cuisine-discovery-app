...
const CUISINES = [
  ...
  { id: 'taiwanese',               flagCode: 'tw',         name: '台湾料理',                   counts: { 'tokyo-23': '15', 'tokyo-outside': '9',  'yokohama-kawasaki': '15', 'kanagawa-other': '0' }, lastUpdated: '2026-03-01', query: 'taiwanese restaurant OR 台湾料理 OR ルーローハン OR 小籠包',                                                                      filterType: 'taiwanese_restaurant',    filterPrimaryType: 'taiwanese_restaurant',    filterLevel: 3, menuItems: ['魯肉飯', '小籠包', 'タピオカティー'] },
  ...
  { id: 'indian',                  flagCode: 'in',         name: 'インド料理',                 counts: { 'tokyo-23': '14',  'tokyo-outside': '12',  'yokohama-kawasaki': '12',  'kanagawa-other': '0' }, lastUpdated: '2026-03-01', query: 'indian restaurant OR インド料理 OR ナン',                                                                                         filterType: 'indian_restaurant',       filterPrimaryType: 'indian_restaurant',       filterLevel: 3, menuItems: ['バターチキンカレー', 'ナン', 'チャパティ'] },
  ...
  { id: 'thai',                    flagCode: 'th',         name: 'タイ料理',                   counts: { 'tokyo-23': '20', 'tokyo-outside': '0',  'yokohama-kawasaki': '9', 'kanagawa-other': '5' }, lastUpdated: '2026-03-01', query: 'thai restaurant OR タイ料理 OR トムヤムクン OR パッタイ',                                                                           filterType: 'thai_restaurant',         filterPrimaryType: 'thai_restaurant',         filterLevel: 3, menuItems: ['トムヤムクン', 'ガパオライス', 'パッタイ'] },
  ...
  { id: 'indonesian-malaysian',    flagCode: 'id',         name: 'インドネシア・マレーシア料理', counts: { 'tokyo-23': '13',  'tokyo-outside': '1',  'yokohama-kawasaki': '5',  'kanagawa-other': '4' }, lastUpdated: '2026-03-01', query: 'indonesian restaurant OR malaysian restaurant OR ナシゴレン OR サテ OR ナシレマ OR ルンダン',                                          filterType: 'indonesian_restaurant',                                                          filterLevel: 2, menuItems: ['ナシゴレン', 'サテ', 'ラクサ'] },
  ...
  { id: 'mexican',                 flagCode: 'mx',         name: 'メキシコ料理',               counts: { 'tokyo-23': '17', 'tokyo-outside': '0',  'yokohama-kawasaki': '14', 'kanagawa-other': '2' }, lastUpdated: '2026-03-01', query: 'mexican restaurant OR メキシコ料理 OR タコス OR ブリトー OR エンチラーダ OR ケサディーヤ',                                              filterType: 'mexican_restaurant',                                                             filterLevel: 2, menuItems: ['タコス', 'ブリトー', 'ナチョス'] },
  { id: 'brazilian',               flagCode: 'br',         name: 'ブラジル料理',               counts: { 'tokyo-23': '20', 'tokyo-outside': '1',  'yokohama-kawasaki': '12', 'kanagawa-other': '2' }, lastUpdated: '2026-03-01', query: 'brazilian restaurant OR ブラジル料理 OR シュラスコ OR フェイジョアーダ',                                                              filterType: 'brazilian_restaurant',                                                           filterLevel: 2, menuItems: ['シュラスコ', 'フェジョアーダ', 'ポンデケージョ'] },
  ...
  // === レベル1: フィルタなし ===
  { id: 'south-indian-sri-lankan', flagCode: 'in',         name: '南インド・スリランカ料理',   counts: { 'tokyo-23': '20',  'tokyo-outside': '1',  'yokohama-kawasaki': '20',  'kanagawa-other': '4' }, lastUpdated: '2026-03-01', query: 'south indian restaurant OR sri lankan restaurant OR ミールス OR スリランカ料理 OR アーユルヴェーダ',                                    filterLevel: 1,                                                                               menuItems: ['ミールス', 'ドーサ', 'ホッパー'] },
  ...
  { id: 'portuguese',              flagCode: 'pt',         name: 'ポルトガル料理',             counts: { 'tokyo-23': '9',  'tokyo-outside': '0',  'yokohama-kawasaki': '3',  'kanagawa-other': '1' }, lastUpdated: '2026-03-01', query: 'portuguese restaurant OR ポルトガル料理 OR バカリャウ',                                                                              filterLevel: 1,                                                                               menuItems: ['バカリャウ', 'パステル・デ・ナタ', 'ガスパチョ'] },
  ...
  { id: 'mongolian',               flagCode: 'mn',         name: 'モンゴル料理',               counts: { 'tokyo-23': '18', 'tokyo-outside': '1',  'yokohama-kawasaki': '13', 'kanagawa-other': '0' }, lastUpdated: '2026-03-01', query: 'mongolian restaurant OR モンゴル料理 OR スーテーツァイ OR ホーショール',                                                            filterLevel: 1,                                                                               menuItems: ['ホーショール', 'ボーズ', '羊肉スープ'] },
  ...
  { id: 'african',                 flagCode: 'africa',     name: 'アフリカ料理',               counts: { 'tokyo-23': '19', 'tokyo-outside': '0',  'yokohama-kawasaki': '5', 'kanagawa-other': '3' }, lastUpdated: '2026-03-01', query: 'african restaurant OR ethiopian restaurant OR egyptian restaurant OR アフリカ料理 OR エチオピア料理 OR エジプト料理 OR コシャリ OR インジェラ', filterLevel: 1,                                                                               menuItems: ['インジェラ', 'コシャリ', 'ジョロフライス'] },
];
