...
const CUISINES = [
  ...
  { id: 'belgian',                 name: 'ベルギー料理',               query: 'belgian restaurant OR ベルギー料理 OR ベルギービール OR ムール貝 OR ベルギーワッフル',                                                              filterType: 'belgian_restaurant',                                                           filterLevel: 2, excludeCommon: false },
  ...
  { id: 'nordic',                  name: '北欧料理',                   query: 'scandinavian restaurant OR swedish restaurant OR danish restaurant OR finnish restaurant OR 北欧料理 OR ミートボール',                             filterLevel: 1, excludeCommon: true  },
  { id: 'mongolian',               name: 'モンゴル料理',               query: 'mongolian restaurant OR モンゴル料理 OR スーテーツァイ OR ホーショール',                                                                            filterLevel: 1, excludeCommon: false },
  { id: 'moroccan',                name: 'モロッコ料理',               query: 'moroccan restaurant OR モロッコ料理 OR タジン鍋 OR クスクス',                                                                                       filterType: 'moroccan_restaurant',                                                          filterLevel: 2, excludeCommon: false },
